...
app.use('/js',express.static(__dirname + '/../js/jquery-3.2.1.min'));
app.use('/js',express.static(__dirname + '/../js/popper.min'));
// app.use('http://localhost:8080/js/popper.min.js');
app.set('port', process.env.PORT || 8080); // main port
